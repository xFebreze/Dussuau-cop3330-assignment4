...
public class ItemControllerTest {
    ...
    public void removeItemTest(){
        ...
        //call remove item
        //loop through items
            //if the item doesn't exist set test case false
        //assert equals test case and false
    }

    @Test
    public void editItemDescriptionTest(){
        //make new item model
        //call edit item description
